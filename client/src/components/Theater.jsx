	...
	return (
		<div className="flex flex-col">
			<div className="flex md:justify-between">
				<h3
					className={`flex w-fit items-center rounded-tl-2xl bg-gradient-to-br from-red-800 to-red-700 px-6 py-0.5 text-2xl font-bold text-white md:rounded-t-2xl md:px-8 ${
				...
				{auth.role === 'admin' && (
					<div className="flex w-fit flex-col gap-x-3 rounded-tr-2xl bg-gradient-to-br from-white-800 to-blue-700 px-4 py-0.5 font-semibold text-white md:flex-row md:gap-x-6 md:rounded-t-2xl md:text-lg md:font-bold">
			...
			<div className="flex flex-col gap-4 rounded-b-md rounded-tr-md bg-gradient-to-br from-white-100 to-white py-4 md:rounded-tr-none">
				{auth.role === 'admin' && (
					<>
						<form
						...
						>
							<div className="flex grow flex-col gap-2 rounded-lg">
								<div className="flex flex-col gap-2 rounded-lg lg:flex-row lg:items-stretch">
									<div className="flex grow-[2] items-center gap-x-2 gap-y-1 lg:flex-col lg:items-start">
										...
										<Select
											...
											classNames={{
												menuButton: (value) =>
													'flex font-semibold text-sm border border-red-300 rounded shadow-sm transition-all duration-300 focus:outline-none bg-white hover:border-red-400 focus:border-white-500 focus:ring focus:ring-white-500/20'
											}}
										/>
									</div>
									<div className="flex items-center gap-x-2 gap-y-1 lg:flex-col lg:items-start">
										...
										<input
											type="time"
											className="h-9 w-full rounded bg-white px-2 py-1 font-semibold text-red-900 drop-shadow-sm"
											required
								...
								<div className="flex flex-col gap-2 rounded-lg lg:flex-row lg:items-stretch">
									...
									>
										...
										<input
											type="time"
											className="h-9 w-full rounded bg-white px-2 py-1 font-semibold text-red-900 drop-shadow-sm disabled:bg-red-300"
											disabled={!watch('autoIncrease')}
											{...register('gap')}
										/>
									</div>
							...
							<button
								...
								className="whitespace-nowrap rounded-md bg-gradient-to-r from-white-600 to-red-500 px-2 py-1 font-medium text-red-700 drop-shadow-md hover:from-white-500 hover:to-blue-400 disabled:from-slate-500 disabled:to-slate-400"
								type="submit"
							>
								ADD +
							</button>
						...
						{filterMovie?.name && (
							<div className="mx-4 flex gap-2 rounded-md bg-gradient-to-r from-white-600 to-blue-500 p-2 text-white">
