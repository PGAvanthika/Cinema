...
const Search = () => {
	...
	return (
		<div className="flex min-h-screen flex-col gap-4 bg-gradient-to-br from-white-900 to-blue-500 pb-8 text-red-900 sm:gap-8">
			<Navbar />
			<div className="mx-4 flex h-fit flex-col gap-2 rounded-lg bg-gradient-to-br from-white-200 to-blue-100 p-4 drop-shadow-xl sm:mx-8 sm:p-6">
				<h2 className="text-3xl font-bold text-red-900">Search Showtimes</h2>
				<div className="flex flex-col gap-2 rounded-md bg-gradient-to-br from-white-100 to-white p-4 transition-all duration-500 ease-in-out">
					<div className="flex items-center justify-between" onClick={() => setIsOpenFilter((prev) => !prev)}>
						<div className="flex items-center gap-2 text-2xl font-bold text-red-900">
					...
					{isOpenFilter && (
						<div className="">
							<div className="flex flex-col">
								<h4 className="pt-1 text-lg font-bold text-red-800">Cinema :</h4>
								<Select
									value={filterCinema}
									options={Array.from(
							...
							<div className="flex flex-col">
								<h4 className="pt-1 text-lg font-bold text-red-800">Theater :</h4>
								<Select
									value={filterTheater}
							...
							<div className="flex flex-col">
								<h4 className="pt-1 text-lg font-bold text-red-800">Movie :</h4>
								<Select
									value={filterMovie}
							...
							<div className="flex flex-col">
								<h4 className="pt-1 text-lg font-bold text-red-800">Date :</h4>
								<Select
									value={filterDate}
									options={Array.from(
										new Set(
								...
								<div className="my-2 flex flex-col items-start gap-x-2 gap-y-1 sm:flex-row sm:items-center">
									<label className="text-md font-semibold text-red-800">From</label>
									<Select
										...
										primaryColor="white"
									/>
									<label className="text-md font-semibold text-red-800">To</label>
									<Select
										value={filterDateTo}
										options={Array.from(
											new Set(
								...
								<div className="flex flex-col items-start gap-x-8 gap-y-2 sm:flex-row sm:items-center">
									<label className="text-md flex items-center justify-between gap-2 font-semibold text-red-800">
										Past Date
										<input
											type="checkbox"
											className="h-6 w-6"
							...
							<div className="flex flex-col">
								<h4 className="pt-1 text-lg font-bold text-red-800">Time :</h4>
								<Select
									value={filterTime}
									options={Array.from(
										new Set(
							...
							<div className="flex flex-col">
								<h4 className="pt-1 text-lg font-bold text-red-800">Release :</h4>
				...
				<div className="flex items-end">
					...
					<div className="flex flex-wrap items-center gap-2 px-1">
						<button
							className="flex w-fit items-center justify-center gap-1 rounded bg-gradient-to-r from-white-600 to-blue-500 py-1 pl-2 pr-1.5 text-sm font-medium text-white hover:from-white-500 hover:to-blue-400 disabled:from-slate-500 disabled:to-slate-400 md:min-w-fit"
				...
				<div
					className={`mb-4 grid max-h-screen overflow-auto rounded-md bg-gradient-to-br from-white-100 to-white`}
					style={{ gridTemplateColumns: '34px repeat(7, minmax(max-content, 1fr)) 104px' }}
				>
					<p className="sticky top-0 flex items-center justify-center rounded-tl-md bg-gradient-to-br from-red-800 to-red-700 text-center text-xl font-semibold text-white">
						<input
							type="checkbox"
							className="h-6 w-6"
							checked={isCheckAll}
					...
					<button
						className="sticky top-0 flex justify-center bg-gradient-to-br from-red-800 to-red-700 hover:from-red-700 hover:to-red-600 px-2 py-1 text-center text-xl font-semibold text-white"
						onClick={() => {
					...
					<p className="sticky top-0 z-[1] flex items-center justify-center gap-2 rounded-tr-md bg-gradient-to-br from-red-800 to-red-700 px-2 py-1 text-center text-xl font-semibold text-white">
					...
					{isFetchingShowtimesDone &&
						filteredShowtimes.map((showtime, index) => {
							...
							return (
								<Fragment key={index}>
									<div
										className={`flex items-center justify-center border-t-2 border-white-200 ${
									...
									<div
										className={`border-t-2 border-white-200 px-2 py-1 ${
											isCheckedRow && 'border-white bg-blue-200 text-blue-800'
										}`}
									>
									...
									<div
										className={`flex items-center gap-2 border-t-2 border-white-200 px-2 py-1 ${
											isCheckedRow && 'border-white bg-blue-200 text-blue-800'
										}`}
									>
										<p>
									...
									<button
										className="flex items-center justify-center gap-2 bg-gradient-to-br from-white-600 to-blue-500 px-2 py-1 text-white drop-shadow-md hover:from-white-500 hover:to-blue-400 disabled:from-slate-500 disabled:to-slate-400"
