...
const TheaterShort = ({ theaterId, movies, selectedDate, filterMovie, rounded = false }) => {
	...
	return (
		<div
			className={`flex flex-col bg-gradient-to-br from-white-100 to-white sm:flex-row sm:rounded-tr-none ${
		...
		>
			<div className="flex flex-col sm:flex-row">
				...
				{auth.role === 'admin' && (
					<div
						className={`flex w-full min-w-[160px] flex-row justify-center gap-x-4 border-b-2 border-white-200 bg-gradient-to-br from-white-100 to-white px-4 py-0.5 text-sm font-bold sm:w-fit sm:flex-col sm:border-none`}
					>
