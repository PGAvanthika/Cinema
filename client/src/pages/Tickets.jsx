...
const Tickets = () => {
	...
	return (
		<div className="flex min-h-screen flex-col gap-4 bg-gradient-to-br from-white-900 to-blue-500 pb-8 text-gray-900 sm:gap-8">
			<Navbar />
			<div className="mx-4 flex h-fit flex-col gap-4 rounded-md bg-gradient-to-br from-white-200 to-blue-100 p-4 drop-shadow-xl sm:mx-8 sm:p-6">
								...
								{tickets.map((ticket, index) => {
									return (
										<div className="flex flex-col" key={index}>
											...
											<div className="flex h-full flex-col justify-between rounded-b-lg bg-gradient-to-br from-white-100 to-white text-center text-lg drop-shadow-lg md:flex-row">
